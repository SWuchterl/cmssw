...
class UnifiedParticleTransformerAK4ONNXJetTagsScoutingProducer : public edm::stream::EDProducer<edm::GlobalCache<ONNXRuntime>> {
public:
  explicit UnifiedParticleTransformerAK4ONNXJetTagsScoutingProducer(const edm::ParameterSet&, const ONNXRuntime*);
  ~UnifiedParticleTransformerAK4ONNXJetTagsScoutingProducer() override = default;
...
private:
  ...
  unsigned n_cpf_;
  constexpr static unsigned n_features_cpf_ = 20;
  ...
  unsigned n_npf_;
  constexpr static unsigned n_features_npf_ = 10;
  constexpr static unsigned n_pairwise_features_npf_ = 4;
  unsigned n_sv_;
  constexpr static unsigned n_features_sv_ = 15;
...
UnifiedParticleTransformerAK4ONNXJetTagsScoutingProducer::UnifiedParticleTransformerAK4ONNXJetTagsScoutingProducer(
...
void UnifiedParticleTransformerAK4ONNXJetTagsScoutingProducer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
  ...
  desc.add<edm::FileInPath>("model_path",
                            edm::FileInPath("RecoBTag/CombinedScouting/data/model.onnx"));
...
std::unique_ptr<ONNXRuntime> UnifiedParticleTransformerAK4ONNXJetTagsScoutingProducer::initializeGlobalCache(
    const edm::ParameterSet& iConfig) {
  return std::make_unique<ONNXRuntime>(iConfig.getParameter<edm::FileInPath>("model_path").fullPath());
}

void UnifiedParticleTransformerAK4ONNXJetTagsScoutingProducer::globalEndJob(const ONNXRuntime* cache) {}

void UnifiedParticleTransformerAK4ONNXJetTagsScoutingProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
...
void UnifiedParticleTransformerAK4ONNXJetTagsScoutingProducer::get_input_sizes(
  ...
  if (use_dynamic_axes_) {
    ...
    n_cpf_ = std::clamp((unsigned int)features.c_pf_features.size(), (unsigned int)1, (unsigned int)26);
...
void UnifiedParticleTransformerAK4ONNXJetTagsScoutingProducer::make_inputs(
...
DEFINE_FWK_MODULE(UnifiedParticleTransformerAK4ONNXJetTagsScoutingProducer);
