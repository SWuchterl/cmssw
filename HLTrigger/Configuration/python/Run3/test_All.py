...
# process = BTV_noCalo_roiPF_DeepCSV(process) ## Calo b-tagging: none ## PF b-tagging: new regional DeepCSV PF b-tagging [new sequence]
...
#process = BTV_globalCalo_globalPF_DeepCSV(process) ## Calo b-tagging: new global calo b-tagging [new sequence] ## PF b-tagging: new global DeepCSV PF b-tagging

#process = BTV_noCalo_roiPF_DeepJet(process) ## Calo b-tagging: none ## PF b-tagging: new regional DeepJet PF b-tagging [new sequence]
...
process = BTV_globalCalo_globalPF_DeepJet(process) ## Calo b-tagging: new global calo b-tagging [new sequence] ## PF b-tagging: new global DeepJet PF b-tagging
