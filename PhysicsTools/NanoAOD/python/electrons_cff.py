...
electronTask = cms.Task(bitmapVIDForEle, bitmapVIDForEleFall17V2, bitmapVIDForEleHEEP, isoForEle, isoForEleFall17V2,
                        ptRatioRelForEle, seedGainEle, calibratedPatElectronsNano, slimmedElectronsWithUserData, finalElectrons)
electronTablesTask = cms.Task(
    electronPROMPTMVA, electronPNetVariables, electronPNetScores, electronParTVariables, electronParTScores, electronParTTrainVariables, electronTable)
