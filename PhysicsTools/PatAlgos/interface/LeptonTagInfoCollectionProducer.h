...
private:
  ...
  template <typename VarType>                                                                                                                   using ExtVarWithName = std::pair<std::string, edm::EDGetTokenT<edm::ValueMap<VarType>>>;
  ...
  private:
    ...
    using LeptonTagInfoCollection = btagbtvdeep::DeepBoostedJetFeaturesCollection;
